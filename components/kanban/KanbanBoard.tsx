...
export function KanbanBoard({ pedidos = [] }: KanbanBoardProps) {
  // Se não houver pedidos, mostramos um aviso simples em vez de tela branca
  if (!pedidos) return <div className="p-8 text-center text-gray-500">Carregando pedidos...</div>

  return (
    <div className="w-full bg-gray-50/50 rounded-xl">
      {/* TRILHO ÚNICO: Títulos + Cards rolam juntos */}
